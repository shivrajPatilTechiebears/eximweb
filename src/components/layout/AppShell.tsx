  ...
  return (
    <div className="h-screen overflow-hidden text-sm text-on-background">
      ...
      <div className="ml-[240px] h-full flex flex-col">
        ...
        <div className="flex-1 min-h-0 mx-3 mb-3 mt-2 rounded-2xl bg-white/70 backdrop-blur-sm overflow-y-auto [&::-webkit-scrollbar]:hidden [scrollbar-width:none] [-ms-overflow-style:none]">
          {children}
        </div>
      </div>
    </div>
